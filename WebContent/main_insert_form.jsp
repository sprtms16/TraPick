...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" type="text/css" href="../main_insert_css.css" />
<script
		...
		$("#target").autocomplete({
			...
			select : function(e, ui) {
				$.getJSON('city?country_name=' + $(this).val(), function(data) {
					$.each(data, function(index, item) {availableTags2.push(item);
					});
					$('#target2').empty();
...
<link
   href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
   rel="stylesheet">
<link rel="stylesheet" type="text/css" href="../style/css/main_insert_css.css" />
<script
   src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
<script
   src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js"></script>
...
<script type="text/javascript">
   $(function() {
      ...
      $('#start_time').datepicker({
         showOn : "both",
         buttonImage : "../style/img/calander.png",
         buttonImageOnly : true,
         dateFormat : "yy-mm-dd",
         changeMonth : true,
         minDate : 0,

...
function initialize() {
    ...
    // Geocoding *****************************************************
    var address = "<%=request.getParameter("city_name")%>
	"; // DB에서 주소 가져와서 검색하거나 왼쪽과 같이 주소를 바로 코딩.
		var marker = null;
													...
													$
															.each(
																	...
																	function(
																			index,
																			item) {
																		var text = '<div class = "drag"><img src = "'+item.image+'"> <span>'
																				+ item.name
																				+ '</span></div>';
																		$(
																				'#landMarkList')
													...
													$
															.each(
																	...
																	function(
																			index,
																			item) {
																		var text = '<div class = "drag"><img src = "'+item.img+'"> <span>'
																				+ item.name
																				+ '</span></div>';
																		$(
																				'#itemList')
		...
		<div class="row">
			<div class="col-6">
				...
				<form action="searchCity" id="searchCity">
					도시 검색 : <input type="text" name="search_City"> <input

...
public class SelectedLandMark {
	...
	public SelectedLandMark() {
		// TODO Auto-generated constructor stub
	}

	public SelectedLandMark(int land_idx, int schd_idx, String name, double latitude, double longitude, String detail,
			String city_name, int time_defference, String country_name, String start_time, String endItme, int rating,
			String memo) {
		super();
	...
	public String toString() {
		return "SelectedLandMark [land_idx=" + land_idx + ", schd_idx=" + schd_idx + ", name=" + name + ", latitude="
				+ latitude + ", longitude=" + longitude + ", detail=" + detail + ", city_name=" + city_name
				+ ", time_defference=" + time_defference + ", country_name=" + country_name + ", start_time="
				+ start_time + ", endItme=" + endItme + ", rating=" + rating + ", memo=" + memo + "]";
	}
